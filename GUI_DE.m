...
pdlist_g2={'Druck vs. Zusammensetzung','Temperatur vs. Zusammensetzung','Druck vs. Temperatur'};
...
Fig = figure('Position',[100,100,1300,600],'menu','none',...
...
intro_gui0={'Willkommen bei OilMixProp 1.0, einem Softwarepaket für wichtige thermophysikalische Eigenschaften von Ölen, gebräuchlichen Flüssigkeiten und deren Mischungen.',...
    ' ',...
    'Hauptfunktionen von OilMixProp 1.0:',...
    '1. Benutzer können mit den Anpassungstools ihre eigenen Öle (Kraftstoffe, Schmierstoffe oder andere Ölvarianten) definieren.',...
    '2. Eingaben und Ausgaben sind speziell für die Analyse von thermodynamischen Kreisläufen konzipiert.',...
    '3. Bisher sind 632 reine Flüssigkeiten mit unbegrenzt benutzerdefinierten Ölen verfügbar.',...
    '4. Wichtige Eigenschaften: Dichte, Phasenverhalten, Wärmekapazität, Entropie, Enthalpie, Schallgeschwindigkeit, Viskosität und Wärmeleitfähigkeit.',...
    ' ',...
    'Modell innerhalb von OilMixProp 1.0:',...
    ' ',...
    '1. Kubische Zustandsgleichung (EoS): Yang-Frotscher-Richter, Patel-Teja Valderrama, Soave-Redlich-Kwong and Peng-Robinson.',...
    '2. Hochmoderne Residual-Entropy-Skalierung (RES) für Viskosität und Wärmeleitfähigkeit.',...
    '3. Ein robuster Flash-Algorithmus, der zuverlässige und stabile Berechnungen des Flüssig-Dampf-Gleichgewichts gewährleistet.',...
    ' ',...
    'Entwickler: Dr. Xiaoxian Yang von TUCtt',...
    'Unterstützt von: Univ.-Prof. Dr.-Ing. Markus Richter und Prof. Dr.-Ing. habil. Thorsten Urbaneck',...
    ' '};
...
Text1_g1 = uicontrol(Pnl1_g1,'style','text',...
    'String','EoS auswählen','Fontsize',fontsize2,...
    'Units','normalized','Position',[0.1,0.83,0.8,0.05],'HorizontalAlignment','left');
Text2_g1 = uicontrol(Pnl1_g1,'style','text',...
    'String','Temperaturabschätzung / K:','Fontsize',fontsize1,...
    'Units','normalized','Position',[0.1,0.31,0.70,0.05],'HorizontalAlignment','left');
Text3_g1 = uicontrol(Pnl1_g1,'style','text',...
    'String','Druckabschätzung / kPa:','Fontsize',fontsize1,...
...
intro_gui4_1={'Benutzerhandbuch: Schritte zur Nutzung'};
intro_gui4_2={'1. Einen Fluid-Ordner erstellen',...
    'Im MATLAB-Interface navigieren Sie zum Ordner „ExpData“, der sich auf der linken Seite befindet.',...
    ' ',...
    'Erstellen Sie innerhalb von „ExpData“ einen neuen Ordner für jede gemessene Flüssigkeit. Benennen Sie den Ordner nach der Flüssigkeit, z. B. „PAG68“. Das Format zur Aufzeichnung der Daten in den .txt-Dateien kann dem Ordner „PAG68“ entnommen werden.',...
    ' ',...
    'Fügen Sie in diesem Ordner die Messdaten (Dampfdruck) in separaten .txt-Dateien hinzu.',...
    ' ',...
    '2. Klicken Sie auf die Schaltfläche „VP-Daten laden“',...
    ' ',...
    '3. Wählen Sie den Ordner „ExpData“ aus',...
    '',...
    '4. Zur Datenbank hinzufügen',...
    ''};
...
Text5_g4 = uicontrol(Pnl1_g4,'style','text',...
    'String','Daten importieren','Fontsize',fontsize2,...
    'Units','normalized','Position',[0.05,0.90,0.6,0.05],'HorizontalAlignment','left');
Text6_g4 = uicontrol(Pnl1_g4,'style','text',...
    'String','EoS auswählen:','Fontsize',fontsize2,...
    'Units','normalized','Position',[0.05,0.4,0.4,0.05],'HorizontalAlignment','left');

intro_gui3_1={'Benutzerhandbuch: Schritte zur Nutzung'};
intro_gu3_2={'1. Einen Fluid-Ordner erstellen',...
    'Im MATLAB-Interface navigieren Sie zum Ordner „ExpData“, der sich auf der linken Seite befindet.',...
    ' ',...
    'Erstellen Sie innerhalb von „ExpData“ einen neuen Ordner für jede gemessene Flüssigkeit. Benennen Sie den Ordner nach der Flüssigkeit, z. B. „PAG68“. Das Format zur Aufzeichnung der Daten in den .txt-Dateien kann dem Ordner „PAG68“ entnommen werden.',...
    ' ',...
    'Fügen Sie in diesem Ordner die Messdaten in separaten .txt-Dateien mit folgendem Namensschema hinzu:',...
    '',...
    ' •  Dichte (erforderlich)'...
    ' •  Fluid_Constants_xxx (xxx ist der Name der Flüssigkeit)'...
    ' •  Wärmekapazität'...
    ' •  Wärmeleitfähigkeit'...
    ' •  Dampfdruck'...
    ' •  Viskosität'...
    '',...
    '2. Klicken Sie auf die Schaltfläche „Dichtedaten“.',...
    '',...
    '3. Wählen Sie den Ordner „ExpData“ aus.',...
    'Im Ordner „ExpData“ suchen Sie die gerade erstellte Flüssigkeitsdatei und wählen Sie sie zum Öffnen aus.',...
    '',...
    '4. Zur Datenbank hinzufügen',...
    ''};
...
%%     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  controls-BUTTON    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     %%%%%%%%%%%%%%%%%%  gui0    %%%%%%%%%%%%%%%%%%
Bt1_g0= uicontrol(Pnl1_g0,'style','pushbutton','String','Berechnung von Eigentum','Fontsize',14,...
    'Units','normalized','Position',[0,0,0.25,1],'Callback',@fluidcalculate_g0);
Bt2_g0 = uicontrol(Pnl1_g0,'style','pushbutton','String','Phasendiagramm von Binärsystemen','Fontsize',14,...
    'Units','normalized','Position',[0.25,0,0.25,1],'Callback',@drawpd_g0);
Bt3_g0= uicontrol(Pnl1_g0,'style','pushbutton','String','Mischungen-Optimierungsprogramm','Fontsize',14,...
    'Units','normalized','Position',[0.75,0,0.25,1],'Callback',@fitckij_g0);
Bt4_g0 = uicontrol(Pnl1_g0,'style','pushbutton','String','Reine-Öle-Optimierungsprogramm','Fontsize',14,...
    'Units','normalized','Position',[0.5,0,0.25,1],'Callback',@fitpo_g0);
%     %%%%%%%%%%%%%%%%%%  gui1    %%%%%%%%%%%%%%%%%%
Bt1_g1 = uicontrol(Pnl1_g1,'style','pushbutton','String','Fluide auswählen','Fontsize',fontsize1,...
...
Bt5_g1= uicontrol(Pnl1_g1,'style','pushbutton','String','Rechnen','Fontsize',fontsize1,...
    'Units','normalized','Position',[0.1,0.03,0.8,0.1],'Callback',@fluidcalculate_g1);
%     %%%%%%%%%%%%%%%%%%  gui2    %%%%%%%%%%%%%%%%%%
Bt1_g2= uicontrol(Pnl1_g2,'style','pushbutton','String','Zeichnen','Fontsize',fontsize3,...
    'Units','normalized','Position',[0.1,0.02,0.8,0.05],'Callback',@drawline_g2);
%     %%%%%%%%%%%%%%%%%%  gui3    %%%%%%%%%%%%%%%%%%
Bt1_g3= uicontrol(Pnl1_g3,'style','pushbutton','String','Anpassung & Berechnung','Fontsize',fontsize2,...
    'Units','normalized','Position',[0.1,0.12,0.8,0.08],'Callback',@fitandcalc_g3);
Bt2_g3= uicontrol(Pnl1_g3,'style','pushbutton','String','Zur Datenbank hinzufügen','Fontsize',fontsize2,...
    'Units','normalized','Position',[0.1,0.02,0.8,0.08],'Callback',@add2database_g3);
Bt3_g3= uicontrol(Pnl1_g3,'style','pushbutton','String','Laden Sie VP-Daten','Fontsize',fontsize2,...
    'Units','normalized','Position',[0.05,0.82,0.6,0.06],'Callback',@loadVPdata_g3);
%     %%%%%%%%%%%%%%%%%%  gui4    %%%%%%%%%%%%%%%%%%
Bt1_g4= uicontrol(Pnl1_g4,'style','pushbutton','String','Dichtedaten','Fontsize',fontsize2,...
...
Bt5_g4= uicontrol(Pnl1_g4,'style','pushbutton','String','Anpassung & Berechnung','Fontsize',fontsize2,...
    'Units','normalized','Position',[0.1,0.12,0.8,0.08],'Callback',@fitandcalc_g4);
Bt6_g4= uicontrol(Pnl1_g4,'style','pushbutton','String','Zur Datenbank hinzufügen','Fontsize',fontsize2,...
...
%     %%%%%%%%%%%%%%%%%%  funcgui0    %%%%%%%%%%%%%%%%%%
    ...
    function tips1(~,~)
        A=fileread('GUI/tips_DE.txt');
        warndlg(A, 'Tips');
    end
    function tips2(~,~)
        A=fileread('GUI/tips2_DE.txt');
        warndlg(A, 'Tips');
    end
    ...
    function setfluid_g1(~,~)
        ...
        Texttmp1_g1 = uicontrol(Pnltmp_g1,'style','text',...
            'String','Verfügbare Flüssigkeiten','Fontsize',10,...
            'Units','normalized','Position',[0.01,0.95,0.3,0.05],'HorizontalAlignment','left');
        Texttmp2_g1 = uicontrol(Pnltmp_g1,'style','text',...
            'String','Ausgewählte Mischungsbestandteile','Fontsize',10,...
            'Units','normalized','Position',[0.59,0.95,0.3,0.05],'HorizontalAlignment','left');
        Bttmp1_g1 = uicontrol(Pnltmp_g1,'style','pushbutton','String','Hinzufügen→','Fontsize',fontsize1,...
            'Units','normalized','Position',[0.43,0.62,0.14,0.06],'Callback',@add2list2_g1);
        Bttmp2_g1= uicontrol(Pnltmp_g1,'style','pushbutton','String','←Entfernen','Fontsize',fontsize1,...
            'Units','normalized','Position',[0.43,0.41,0.14,0.06],'Callback',@delfromlist_g1);
        Bttmp3_g1= uicontrol(Pnltmp_g1,'style','pushbutton','String','OK','Fontsize',fontsize1,...
            'Units','normalized','Position',[0.43,0.2,0.14,0.06],'Callback',@list2table_g1);
    ...
    function drawline_g2(~,~)
        ...
        switch varpd_g2
            ...
            case 1
                ...
                CubicEOS = shortEOS{vareos_g2};     % choose the cubic eos  AllEOS = {'PR','SRK','PTV','YFR'};
