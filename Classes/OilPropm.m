function ff = OilPropm(parameter_1,value_1,parameter_2,value_2,Zi,GL,T_K_guess,p_pa_guess)
...
% the unit system: K, mol, J, m, Pa (molar mass: g/mol)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if strcmpi(parameter_1,'T')
        ...
        elseif strcmpi(parameter_2,'D')
            temp = value_1;
            v_molar_all = 1/value_2;   % might be in two phase region
